import 'dart:convert';
import 'package:preparatoriosegundoparcialflorenciaramirez/student.dart';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';

class ApiService {
  final String url =
      "https://appserviceflorencia.azurewebsites.net/api/Students";
  ...
  Future<List<Student>> getStudents() async {
    ...
    if (response.statusCode == 200) {
      ...
      return jsonResponse
          .map((student) => new Student.fromJson(student))
          .toList();
    } else
      throw Exception('Failes to load students from API');
  }
  ...
  Future<Student> postStudent(Student student) async {
    ...
    Map data = {
      ...
      'EnrollermentDate': DateTime.now().toIso8601String() + '+00:00'
    };
